...
export default function EditPrivateLesson() {
  ...
  useEffect(() => {
    axios
      .get(`${urlPrivateLessons}/PutGet/${id}`)
      .then((response: AxiosResponse<courseDTO>) => {
        ...
        if (response.data.courseHomePage == null) {
          response.data.courseHomePage = "";
        }
  ...
  return (
    <div className="container mt-3">
      ...
      {privateLesson && privateLessonPutGet ? (
        <CourseForm
          title="Edytuj korepetycję"
